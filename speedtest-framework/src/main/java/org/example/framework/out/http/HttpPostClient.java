...
public final class HttpPostClient extends AbstractHttpClient {
    ...
    public TransferTestResult partialPostUploadData(final String urlString, final long timeoutTime, final String dataString) {
    ...
    public String postBodyWithSharedData(final String urlString, final String encodedBody) throws ServerRequestException {
